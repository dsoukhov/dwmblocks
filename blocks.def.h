...
static const Block blocks[] = {
  ...
  /* {"","INTERFACE=wlan0 /usr/lib/i3blocks/wifi/wifi", 5, 0, 0}, */
  ...
  {"BAT0: ", "BAT_NUMBER=0 BAT_NUM_HIB=1 ~/scripts/battery", 5, 0, 0},
  {"BAT1: ", "BAT_NUMBER=1 HIB_LVL=1 HIB_WARN=3 BAT_NUM_HIB=1 ~/scripts/battery", 5, 0, 0},
